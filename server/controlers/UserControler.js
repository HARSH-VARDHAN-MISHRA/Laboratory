...
exports.register = async (req, res) => {
    try {
        ...
        const emailOptions = {
            email: email,
            subject: 'Welcome to Lab Mantra - Verification Code Inside',
            message: `
              <html>
                <head>
                  <style>
                ...
                <body>
                  <div class="container">
                    ...
                    <div class="content">
                      ...
                      <p>Thank you for joining us at Lab Mantra. If you have any questions, feel free to contact our support team.</p>
                    </div>
                    <div class="footer">
                      &copy; ${new Date().getFullYear()} Lab Mantra. All rights reserved.
                    </div>
                  </div>
                </body>
              </html>
...
exports.verifyOtpForSignIn = async (req, res) => {
    try {
        ...
        if (existingUserByMail.OtpForVerification === otps ) {
            ...
            const emailOptions = {
                email: email,
                subject: 'Welcome to Lab Mantra - Verification Successful',
                message: `
                  <html>
                    <head>
                      <style>
...
exports.ResendSignOtp = async (req, res) => {
    try {
        ...
        const options = {
          email: email,
          subject: "Lab Mantra Sign In OTP Request - Resend OTP",
          message: `
            <html>
              <head>
                <style>
              ...
              <body>
                <div class="container">
                  <div class="header">
                    <h2>Lab Mantra Sign In OTP Request - Resend OTP</h2>
                  </div>
                  <div class="content">
