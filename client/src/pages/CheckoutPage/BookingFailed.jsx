    ...
    if (user) {
      ...
      const fetchBooking = async () => {
        try {
          ...
          const FilterOrder = AllOrder.filter((item) => item._id === query)
          console.log(FilterOrder);
          
            setBooking(FilterOrder); // Assuming the first entry is the relevant booking
    ...
    <div className="container book-confirm my-5">
      <div className="row ">
        <div className="col-lg-6 col-md-6 col-sm-12" style={{ padding: '30px', borderRadius: '12px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }} >
          ...
          <p className="mt-4 text-uppercase " style={{ color: 'var(--color-began)', textAlign: 'center', fontSize: '1.3rem' }}>Our team will contact you soon.</p>
          <div className="text-center mt-4">
            <Link to="/" className="btn btn-primary" style={{ backgroundColor: 'var(--color-began)', borderColor: 'var(--color-blue)', padding: '10px 20px', fontSize: '1rem' }}>Back to Homepage</Link>
          </div>
        </div>
        <div className="col-lg-6 d-none d-lg-block" >
          <svg xmlns="http://www.w3.org/2000/svg" width="80%" height="500" viewBox="0 0 443.57 607.17" xmlnsXlink="http://www.w3.org/1999/xlink">
            ...
            <circle cx="296.07" cy="386.91" r="68.31" fill="#7d68bf" stroke-width="0" />
            ...
            <path id="uuid-aacd27ab-43c3-4d3d-aa57-4e8c94c3c81e-267" d="m60.38,436.33c-1.04,5.45,1.03,10.4,4.64,11.05,3.6.65,7.37-3.25,8.41-8.7.45-2.17.35-4.42-.29-6.55l12.74-85.41-17.16-3.03-5.65,86.63c-1.38,1.77-2.31,3.83-2.69,6.02h0Z" fill="#f3a3a6" stroke-width="0" />
            <path d="m95.06,298.96l-11.69.13c-8.25,1.34-10.45,5.78-12.23,13.94-2.73,12.45-6.21,29.04-5.48,29.27,1.17.38,21.17,9.52,31.29,7.26l-1.89-50.6Z" fill="#7d68bf" stroke-width="0" />
            ...
            <path d="m118.79,385.68l-43.56.48-3.5,40.56,18.96,149.54,22.24-.25-9.85-86.38,36.94,77.68,19.61-14.06-28.98-72.58s9.36-63.61,1.28-79.34-13.13-15.67-13.13-15.67v.02h0Z" fill="#2f2e43" stroke-width="0" /><polygon points="140.48 387.91 71.3 388.68 91.06 299.01 121.21 298.67 140.48 387.91" fill="#7d68bf" stroke-width="0" />
            <path id="uuid-36382701-bf34-46f2-bbf2-9fa794ab079f-268" d="m147.24,435.37c1.16,5.43-.8,10.42-4.39,11.15-3.59.73-7.44-3.08-8.6-8.51-.5-2.16-.45-4.41.14-6.56l-14.64-85.11,17.09-3.41,7.57,86.49c1.42,1.74,2.39,3.78,2.83,5.96h0Z" fill="#f3a3a6" stroke-width="0" />
            <path d="m109.52,298.8l11.69-.13c8.28,1.16,10.57,5.55,12.54,13.67,3,12.39,6.85,28.89,6.13,29.14-1.17.4-20.95,9.98-31.12,7.95l.77-50.63h-.01Z" fill="#7d68bf" stroke-width="0" />
